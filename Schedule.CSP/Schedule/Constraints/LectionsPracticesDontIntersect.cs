...
{
    public class LectionsPracticesDontIntersect : IConstraint<InfoVar, (int auditoryId, int dayTimeId)>
    {
        private readonly IEnumerable<InfoVar> _scope;
        private readonly ScheduleContext _context;

        public LectionsPracticesDontIntersect(InfoVar var1, InfoVar var2, ScheduleContext context)
        {
